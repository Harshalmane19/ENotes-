           ...
           <div class="row">
               <div class="col-md-12">
                   ...
                   %>
                                ...
                                <div class="card mt-3">
                       <img alt="" src="img/unnamed.png" class="card-img-top mt-2 mx-auto" style="max-width:100px;"><!-- comment -->
                       <div class="card-body p-4">
                           ...
                           <div class="container text-center mt-2">
                               <a href="deleteServlet?note_id=<%=po.getId()%>" class="btn btn-danger">Delete</a><!-- comment -->
